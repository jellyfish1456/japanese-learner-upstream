        ...
        <div key={`${currentDayIndex}-${currentIndex}`} className="slide-in">
          ...
          <div className="flex justify-end gap-1 mt-2">
            ...
            <button
              ...
              className={`p-2 transition-colors tap-active ${reviewList.includes(currentItem.id) ? "text-amber-400" : "text-gray-300 dark:text-gray-600 hover:text-amber-400"}`}
              title="加入再次複習"
            >
              <svg className="w-7 h-7" fill={reviewList.includes(currentItem.id) ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
